...
namespace Prog1AFixed
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            GroundPackage gp1 = new GroundPackage(a1, a3, 20.6, 15, 34.5, 20);
            Console.WriteLine(gp1);

            NextDayAirPackage ndap1 = new NextDayAirPackage(a1, a2, 28.2, 12.3, 61.5, 50, 4);
            Console.WriteLine(ndap1);

            TwoDayAirPackage tdap1 = new TwoDayAirPackage(a3, a4, 20.3, 25.4, 50.6, 78.6, 0);
            Console.WriteLine(tdap1);
        }
    }
}
